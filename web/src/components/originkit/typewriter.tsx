// Origin Kit — typewriter (originkit.dev)
// Fetched via the Origin Kit MCP registry as nextjs/tailwind/ts.
// TS fix (as in the team's own fork): props/defaults typed as Partial<Props>
// so an object-literal `ease` is contextually typed against AnimationOptions.
